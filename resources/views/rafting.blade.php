...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Ubud Rafting | Services - Rafting</title>
    ...
    <body>
                ...
                <div
                    ...
                    <div
                        ...
                        <h2 class="text-3xl text-white font-bold xl:text-5xl lg:text-4xl sm:text-3xl m:text-2xl "
                            style="line-height: 120%">Rafting Activities</h2>
                        ...
                        <div class="p-8">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 mr-auto">
                                    <p class="text-xl font-semibold text-black">Rafting</p>
                                </div>
                    ...
                    <div class="overflow-hidden bg-white rounded shadow" data-aos="fade-up" data-aos-delay="300">
                        <div class="p-8">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 mr-auto">
                                    <p class="text-xl font-semibold text-black">Pick Up Car</p>
                    ...
                    <div class="overflow-hidden bg-white rounded shadow" data-aos="fade-up" data-aos-delay="600">
                        <div class="p-8">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 mr-auto">
                                    <p class="text-xl font-semibold text-black">Rafting Guide</p>
                    ...
                    <div class="overflow-hidden bg-white rounded shadow" data-aos="fade-up" data-aos-delay="700">
                        <div class="p-8">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 mr-auto">
                                    <p class="text-xl font-semibold text-black">Shower Facilities</p>
                    ...
                    <div class="overflow-hidden bg-white rounded shadow" data-aos="fade-up" data-aos-delay="800">
                        <div class="p-8">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 mr-auto">
                                    <p class="text-xl font-semibold text-black">Changing Room</p>
        ...
        <script>
            var swiper = new Swiper(".centered-slide-carousel", {
                    ...
                    autoplay: {
                        delay: 3000, // Waktu antar slide, dalam milidetik (3 detik)
