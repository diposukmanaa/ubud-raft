...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            <div class="max-w-2xl mx-auto text-center"> 
                <h2 class="text-3xl pb-5 font-bold leading-tight text-black sm:text-4xl lg:text-5xl">
            ...
            <div class="grid max-w-md grid-cols-1 gap-3 mx-auto mt-8 lg:mt-16 lg:grid-cols-3 lg:max-w-full lg:gap-8">
                <!-- Card 1 -->
