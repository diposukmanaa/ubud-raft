            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center flex-col lg:flex-row md:mt-20">
                    <div class="w-full lg:w-1/2">
                        <h2
                            class="font-manrope text-4xl text-gray-900 font-bold leading-[4rem] mb-5 text-center lg:text-left" data-aos="fade-up" data-aos-duration="800">Singapadu ATV Adventure</h2>
                        <p class="text-m text-gray-500 mb-5 text-center lg:text-justify w-full lg:w-2/3" data-aos="fade-up" data-aos-duration="800">Riding an ATV in Singapadu offers an unforgettable adventure surrounded by stunning natural beauty. As you embark on a thrilling off-road journey, you'll navigate through rugged terrain, passing by lush rice paddies, dense forests, and traditional Balinese villages. Along the way, you'll experience the excitement of conquering challenging trails while being immersed in the serenity of Bali's rural landscape. You'll also have the unique opportunity to witness the rich cultural heritage of the island, making it a truly immersive experience.</p>
                        <p class="text-m text-gray-500 mb-5 text-center lg:text-justify w-full lg:w-2/3" data-aos="fade-up" data-aos-duration="800">With an ATV ride lasting around 2.5 to 3 hours, this adventure gives you ample time to soak in the breathtaking scenery and fully immerse yourself in Bali's rural charm. Led by a skilled and experienced guide, your safety and enjoyment are prioritized throughout the journey, ensuring a smooth and thrilling ride. Whether you're seeking adrenaline-pumping action or a deeper connection with Bali’s natural beauty and culture, an ATV adventure in Singapadu promises a truly memorable experience to enhance your Bali holiday.</p>
                    ...
                    <div class="w-full lg:w-1/2 lg:mt-0 md:mt-40 mt-16 max-lg:max-w-2xl">
                        <div class="grid grid-cols-2 min-[450px]:grid-cols-2 md:grid-cols-3 gap-4" >
                            <img src="{{ asset('images/image-1.png')}}" alt="Team tailwind section"
                            ...
                            <img src="{{ asset('images/image-3.png')}}" alt="Team tailwind section"
                            ...
                            <img src="{{ asset('images/DSC03416.jpg')}}" alt="Team tailwind section"
        ...
        <section class="py-10 sm:py-16 lg:py-24 bg-white">
            <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="max-w-2xl mx-auto text-center" data-aos="fade-up" data-aos-duration="800">
                    ...
                    <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-600">The atv package includes safety equipment, experienced guide, welcome drink, towel, shower facilities, and a delicious buffet lunch.</p>
                </div>
